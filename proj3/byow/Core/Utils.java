...
class Utils {
    ...
    /** The .byow directory.*/
    static final File BYOW_DIR = join(CWD, ".byow");
    /** The seed file.*/
    static  final File WORLD_FILE = join(BYOW_DIR, "world.txt");
    ...
    /** the helper methods especially for BYOW proj .*/
    /** read exists RogWorld object from file, if the file doesn't exist, return null.*/
    static RogWorld readRogWorld() {
        if (!WORLD_FILE.exists()) {
            return null;
        }
        return readObject(WORLD_FILE, RogWorld.class);
    }
